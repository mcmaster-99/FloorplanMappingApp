...
window.Modernizr = function (e, t, n) {
  function r(e) {
    ...
    for (var r in e) {
      var o = e[r];if (!i(o, "-") && b[o] !== n) return "pfx" != t || o;
    }return !1;
  }function s(e, t, r) {
    for (var o in e) {
    ...
    p.input = function (n) {
      ...
      for (var r, o, a, i = 0, c = e.length; i < c; i++) {
    ...
    var a,
        ...
        l = t.body,
        d = l || t.createElement("body");if (parseInt(r, 10)) for (; r--;) {
    ...
    var t = this;if ("function" != typeof t) throw new TypeError();var n = D.call(arguments, 1),
      ...
      if (this instanceof r) {
        var o = function o() {};o.prototype = t.prototype;var a = new o(),
    ...
    var e = !!u("perspective");return e && "webkitPerspective" in g.style && F("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function (t, n) {
    ...
    function n(e, t) {
      ...
      if (e || (e = t), l) return e.createDocumentFragment();n = n || o(e);for (var a = n.frag.cloneNode(), i = 0, c = r(), s = c.length; i < s; i++) {
        a.createElement(c[i]);
      }return a;
    }function c(e, t) {
